            ...
            >
              <LayoutClient>
                <Routes>
                  ...
                  <Route path="/rescue-seeker" element={<RescueSeeker />} />
              ...
              <LayoutAdmin>
                <Routes>
                  <Route
                    ...
                    element={<AuthenticatedAdminNaturalDisaster />}
                  />
                  <Route
                    path="/problem"
                    element={<AuthenticatedAdminProblem />}
                  />
                  <Route path="/user" element={<AuthenticatedAdminUser />} />
                  <Route
                    path="/employee"
                  ...
                  <Route
                    ...
                    element={<AuthenticatedAdminHistoryNatural />}
                  />
                  <Route
                    path="/history-problem"
                    element={<AuthenticatedAdminHistoryProblem />}
                  />
                </Routes>
              </LayoutAdmin>
            </motion.div>
